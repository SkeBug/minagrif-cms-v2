...
const config = {
  ...
  translations: {
    pt: {
      ...
      "Auth.form.button.login.strapi": "Entrar",
      ...
      "Auth.form.email.placeholder": "evandro.silva@equilibrium.co.ao",
      ...
      "Auth.form.firstname.placeholder": "ex: Evandro",
      ...
      "Auth.form.lastname.placeholder": "ex: Silva",
      ...
      "Auth.form.username.placeholder": "Evandro Silva",
      ...
      "HomePage.welcome.congrats.content": "Você está logado como o primeiro administrador. Para descobrir os recursos avançados fornecidos pelo CMS,",
      ...
      "Settings.application.strapi-version": "versão do painel",
      "Settings.application.strapiVersion": "versão do painel",
      ...
      "Settings.application.customization.carousel.change-action": "Alterar logótipo",
      "Settings.application.customization.carousel.reset-action": "Redefinir logótipo",
      "Settings.application.customization.carousel-slide.label": "Slide do logótipo",
      ...
      "admin.pages.MarketPlacePage.subtitle": "Faça mais com o CMS",
      "admin.pages.MarketPlacePage.tab-group.label": "Plugins e Provedores para CMS",
      ...
      "app.components.BlockLink.blog.content": "Leia as últimas notícias do CMS e seu ecossistema.",
      ...
      "app.components.BlockLink.tutorial.content": "Siga o passo-a-passo para usar e customizar o CMS.",
      ...
      "app.components.HomePage.welcomeBlock.content.again": "Desejamos que você esteja progredindo em seu projeto... Fique por dentro das últimas novidades sobre o CMS. Estamos sempre dando o nosso melhor para melhorar o produto sempre baseando-se em sua opinião.",
      ...
      "app.components.LeftMenu.navbrand.title": "Painel de gestão",
      ...
      "app.components.MarketplaceBanner": "Descubra extensões da comunidade, e muito mais para dar início ao seu projeto, em CMS Awesome.",
      ...
      "components.AutoReloadBlocker.description": "Execute o CMS com um dos seguintes comandos:",
      ...
      "content-manager.DynamicTable.relation-loading": "As relações estão carregando",
      "content-manager.DynamicTable.relation-more": "Esta relação contém mais entidades do que as exibidas",
      ...
      "global.plugins.sentry.description": "Envie eventos de erro do CMS para o Sentry.",
      ...
      "notification.version.update.message": "Uma nova versão do CMS está disponível!",
